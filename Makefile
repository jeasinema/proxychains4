...
CFLAGS_MAIN=-DLIB_DIR=\"/home/maxiaojian/scratch/clash/proxychains-master\" -DINSTALL_PREFIX=\"$(prefix)\" -DDLL_NAME=\"$(LDSO_PATHNAME)\" -DSYSCONFDIR=\"$(confdir)\"
...
%.o: %.c
	$(CC) $(CCFLAGS) $(CFLAGS_MAIN) $(INC) $(PIC) -c -o $@ $< -ldl

$(LDSO_PATHNAME): $(LOBJS)
	$(CC) $(LDFLAGS) $(LD_SET_SONAME)$(LDSO_PATHNAME) -o $@ $(LOBJS) -ldl

$(ALL_TOOLS): $(OBJS)
	$(CC) src/main.o src/common.o -o $(PXCHAINS) -ldl
